...
def run_AI_all(
    ...
    # Run bf and polyfit
    PA = run_bf_polyfit(
        pathdir, pathdir, filename, BF_try_time, BF_ops_file_type, PA, polyfit_deg
    )
    ...
    if idx_min == 0:
        ...
        new_pathdir, new_filename = do_translational_symmetry_minus(
            pathdir, filename, symmetry_minus_result[1], symmetry_minus_result[2]
        )
        PA1_ = ParetoSet()
        PA1 = run_AI_all(
            new_pathdir,
        ...
        new_pathdir, new_filename = do_translational_symmetry_multiply(
            pathdir, filename, symmetry_multiply_result[1], symmetry_multiply_result[2]
        )
        PA1_ = ParetoSet()
        PA1 = run_AI_all(
            new_pathdir,
        ...
        new_pathdir, new_filename = do_translational_symmetry_divide(
            pathdir, filename, symmetry_divide_result[1], symmetry_divide_result[2]
        )
        PA1_ = ParetoSet()
        PA1 = run_AI_all(
            new_pathdir,
        ...
        (
            ...
            pathdir, filename, separability_plus_result[1], separability_plus_result[2]
        )
        PA1_ = ParetoSet()
        PA1 = run_AI_all(
            new_pathdir1,
